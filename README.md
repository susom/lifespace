...
> [!NOTE]
> This repository contains an earlier version of the LifeSpace app, which is no longer actively maintained. The app has since been redesigned and rebuilt using the [Stanford Spezi](https://github.com/StanfordSpezi) framework. You can find the latest version here: https://github.com/stanfordmed/LifeSpace.
