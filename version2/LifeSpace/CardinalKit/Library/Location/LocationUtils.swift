...
class LocationUtils {
    ...
    /// - Returns: Boolean
    public static func isAboveMinimumDistance(previousLocation: CLLocationCoordinate2D,
                                currentLocation: CLLocationCoordinate2D) -> Bool {
        let lastLocation = CLLocation(latitude: previousLocation.latitude,
                                      longitude: previousLocation.longitude)
        let newLocation = CLLocation(latitude: currentLocation.latitude,
