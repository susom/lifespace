        ...
        if let type = data["type"] as? String
        {
            ...
            case "scale":
                if let max = data["max"] as? String,
                   ...
                   let minValueDescription = data["minValueDescription"] as? String{
                    ...
                    let healthScaleAnswerFormat = ORKAnswerFormat.scale(withMaximumValue: intMax,
                                                                        minimumValue: intMin,
                                                                        defaultValue: 3,
                                                                        step: intStep,
            ...
            case "numeric":
                   ...
                   let maxFractionDigits = data["maxFractionDigits"] as? String
                {
                    ...
                    let NumericAnswerFormat = ORKNumericAnswerFormat(style: ORKNumericAnswerStyle(rawValue: 1)!,
                                                                     unit: unit,
